    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-12 lg:col-span-8">
          <div className="h-8 w-2/3 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-2" />
          <div className="h-4 w-1/2 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mb-6" />
          ...
          <div className="space-y-2 mb-6">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="h-4 w-3/4 bg-gray-200 dark:bg-gray-700 rounded animate-pulse" />
            ))}
          </div>
