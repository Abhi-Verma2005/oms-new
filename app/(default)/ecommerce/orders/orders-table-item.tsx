...
export default function OrdersTableItem({ order, onCheckboxChange, isSelected, visibleColumns, totalRenderedColumns }: OrdersTableItemProps) {
    ...
    <tbody className="text-sm">
      ...
      */}
      <tr id={`description-${order.id}`} role="region" className={`${!descriptionOpen && 'hidden'}`}>
        <td colSpan={totalRenderedColumns} className="px-2 first:pl-5 last:pr-5 py-3">
