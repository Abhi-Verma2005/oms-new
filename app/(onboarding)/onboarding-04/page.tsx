...
export default function Onboarding04() {
  ...
  useEffect(() => {
    // Try to fetch company name from profile to personalize
    ;(async () => {
      try {
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <div className="text-center">
                  ...
                  <h1 className="text-3xl text-gray-800 dark:text-gray-100 font-bold mb-8">Nice to have you{companyName ? `, ${companyName}` : ''} 🙌</h1>
