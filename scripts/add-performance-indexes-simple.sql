-- Simple Performance Indexes for AI Chat System
-- These indexes will improve query performance

-- Index for user_knowledge_base user_id and created_at queries
CREATE INDEX IF NOT EXISTS idx_user_knowledge_base_user_created 
ON user_knowledge_base(user_id, created_at DESC);

-- Index for content type filtering
CREATE INDEX IF NOT EXISTS idx_user_knowledge_base_user_content_type 
ON user_knowledge_base(user_id, content_type);

-- Index for semantic cache queries
CREATE INDEX IF NOT EXISTS idx_semantic_cache_user_query 
...
CREATE INDEX IF NOT EXISTS idx_rag_performance_user_timestamp 
