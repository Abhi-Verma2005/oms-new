...
export function AIAssistantButton() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-5 right-5 z-50 h-12 w-12 rounded-full shadow-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet-400 focus:ring-offset-2 ${
        isSidebarOpen 
      ...
      aria-label={isSidebarOpen ? "Close AI Assistant" : "Open AI Assistant"}
    >
