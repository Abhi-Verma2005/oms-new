...
import FeatureImg01 from '@/public/images/applications-image-01.jpg'
import FeatureImg02 from '@/public/images/applications-image-02.jpg'
import FeatureImg03 from '@/public/images/applications-image-03.jpg'
          ...
          <div className="relative pb-12 md:pb-20">
            ...
            <Highlighter className="grid md:grid-cols-12 gap-6 group">
              ...
              <div className="md:col-span-12" data-aos="fade-down">
                <HighlighterItem>
                  <div className="relative h-full bg-gray-900 dark:bg-gray-800 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        ...
                        <div>
                          <a className="btn-sm text-gray-300 hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(var(--color-gray-900),var(--color-gray-900))_padding-box,conic-gradient(var(--color-gray-400),var(--color-gray-700)_25%,var(--color-gray-700)_75%,var(--color-gray-400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-gray-800/30 before:rounded-full before:pointer-events-none" href="#0">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <svg className="shrink-0 fill-gray-300" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                ...
                <h4 className="font-medium text-gray-50 dark:text-gray-50">Filters</h4>
              </div>
              <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-gray-50 dark:text-gray-50">Configurable</h4>
              </div>
              <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-gray-50 dark:text-gray-50">Adaptable</h4>
              </div>
              <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-gray-50 dark:text-gray-50">Authorization</h4>
              </div>
              <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-gray-50 dark:text-gray-50">Management</h4>
              </div>
              <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-gray-50 dark:text-gray-50">Building</h4>
              </div>
              <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
          </div>
