      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">Many desktop publishing packages and web page editors now use lorem ipsum as their default model text, and a search will uncover many web sites still in their infancy.</p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Discussions</h4>
                  </div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Team views</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Powerful search</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Analytics</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Notifications</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Integrations</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Privacy</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Data export</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-gray-50 dark:text-gray-50">Real-time sync</h4>
                  </div>
                  <p className="text-sm text-gray-400 dark:text-gray-400">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
