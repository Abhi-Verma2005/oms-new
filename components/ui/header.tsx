        ...
        >
          ...
          <div className="flex">
            ...
            >
              ...
              <svg
                className="w-6 h-6 fill-current transition-transform duration-150 will-change-transform group-active:scale-90"
                viewBox="0 0 24 24"
          ...
          <div className="flex items-center space-x-3 relative z-30">
            ...
            <Link
              href="/publishers"
              className="hidden md:inline-flex items-center px-3 py-1.5 rounded-lg border border-violet-300 text-sm text-gray-700 hover:bg-violet-50 dark:border-violet-500/40 dark:text-gray-200 dark:hover:bg-violet-500/10"
            >
              Publishers
            </Link>
            {/* Credits Display */}
            <div className="relative">
              <button
                ...
                className="hidden md:inline-flex items-center px-3 py-1.5 rounded-lg border border-violet-300 text-sm text-gray-700 hover:bg-violet-50 dark:border-violet-500/40 dark:text-gray-200 dark:hover:bg-violet-500/10 transition-colors cursor-pointer"
                title="Daily credits"
              >
                Credits: {credits ?? "—"}
              </button>
            ...
            <div className="relative group">
              <button
                className={`w-8 h-8 flex items-center justify-center cursor-pointer hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full ml-3 ${
              ...
              <div className="absolute top-auto left-1/3 bg-gray-900 dark:bg-gray-700 text-white dark:text-gray-200 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
                ⌘K
              </div>
