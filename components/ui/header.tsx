      ...
      <div className="px-3 sm:px-4 md:px-6 lg:px-8">
        <div className={`flex items-center justify-between h-14 sm:h-16 ${variant === 'v2' || variant === 'v3' ? '' : 'lg:border-b border-gray-200 dark:border-gray-700/60'}`}>
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3 relative z-30">
            ...
            <div className="relative group">
              <button
                className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#6A5ACD] hover:bg-[#5a4ac0] dark:bg-[#6A5ACD] dark:hover:bg-[#5a4ac0] rounded-full shadow-lg hover:shadow-xl transition-all duration-200 border-2 border-[#6A5ACD]/20 hover:border-[#6A5ACD]/40"
                onClick={toggleSidebar}
                title="AI Assistant (⌘K)"
              >
                <svg
                  className="h-4 w-4 sm:h-5 sm:w-5 fill-white drop-shadow-sm"
                ...
                <span className="text-white font-medium text-xs hidden sm:block">AI Assistant</span>
              </button>
