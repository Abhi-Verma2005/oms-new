...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      // Thin, subtle dark-mode styling to avoid bright borders
      "border-[0.5px] dark:bg-gray-800 dark:text-gray-300 dark:border-white/10",
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Solid surfaces to prevent show-through in light mode
        "bg-white text-foreground dark:bg-gray-900 dark:text-gray-200 border-[0.5px] dark:border-white/10",
        position === "popper" &&
